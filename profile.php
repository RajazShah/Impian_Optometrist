...
$orders = [
    ['order_id' => '1001', 'order_date' => '2025-10-15', 'total' => '336.00', 'status' => 'Delivered'],
    ['order_id' => '1002', 'order_date' => '2025-09-20', 'total' => '276.00', 'status' => 'Delivered'],
];
...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="main-nav"><ul><li><a href="index.php#frames-section">Frames</a></li><li><a href="#" class="active">Contact Lense</a></li><li><a href="#">Clip On</a></li></ul></nav>
                        ...
                        <tbody>
                            <?php foreach ($orders as $order): ?>
                                <tr>
                                    ...
                                    <td>RM <?php echo htmlspecialchars($order['total']); ?></td>
