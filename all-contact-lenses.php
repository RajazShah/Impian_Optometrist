...
<head>
    ...
    <title>All Contact Lenses - Impian Optometrist</title> 
...
<body class="page-background"> 
    ...
    <main class="all-frames-container">
        <h1>All Contact Lenses</h1>
        <a href="index.php#contact-section" class="btn-back">← Back to Home</a>

        <form action="all-contact-lenses.php" method="GET" class="filter-form">
